...
def ensure_cookies_file():
    """Создаёт cookies-файл из переменной окружения YOUTUBE_COOKIES_CONTENT, если она задана, либо из хардкод-строки (для теста)."""
...
'''
    path = settings.youtube_cookies_file_path or "/app/youtube_cookies.txt"
